...
![License](https://img.shields.io/github/license/hypertrack/quickstart-flutter.svg)
...
Open the Quickstart project inside the workspace and set your Publishable Key (from [Setup page](https://dashboard.hypertrack.com/setup)) inside the placeholder in the [`main.dart`](<Github link here>) file.
